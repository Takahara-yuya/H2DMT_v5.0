...
public:
	...
	double alpha, damp, dt, v2h, gamma, smdw, t1, t2;
	double c1, c2;
...
private:
	...
	void _Print_Information(double nit, double Data_Misfit, double f_ref, double TE_Misfit, double TM_Misfit,
		MTMesh2D model, MTData2D data_cal, MTData2D data_cal_err, MTFwd2D fwd);

	void _Quadratic_Approximation(VectorXd& g, MatrixXd& H, double& Fai_ref, VectorXd Rn, MatrixXd& J, VectorXd m, VectorXd mapr, int calc);
